package com.example.QQ.ui.friends;
...
import com.example.QQ.component.SideBar;
import com.example.QQ.component.FriendsSlideLayout;
...
public class FriendsFragment extends Fragment {
    ...
    private void initData() {
        ...
        list.add(new Friends("薄青"));
        list.add(new Friends("秦百盛"));
        list.add(new Friends("风天语"));
        list.add(new Friends("凤九歌"));
        list.add(new Friends("柳贯一"));
        list.add(new Friends("陶铸"));
        list.add(new Friends("武庸"));
        list.add(new Friends("商心慈"));
        list.add(new Friends("铁若男"));
        list.add(new Friends("黑楼兰"));
        list.add(new Friends("马鸿运"));
