...
public class ChatGptPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 使用 LinearLayoutManager 并启用 setStackFromEnd
    ...
    private void addToChat(String message, String sender) {
        ...
        runOnUiThread(() -> {
            ...
            recyclerView.smoothScrollToPosition(messageList.size() - 1); // 滚动到最新消息
        });
    }
    ...
    private void loadMessages() {
        ...
        recyclerView.scrollToPosition(messageList.size() - 1); // 确保直接显示最新消息位置
    }
